<template>
  ...
  <header class="topbar">
        ...
        <!-- Logo -->
        <!-- ============================================================== -->
        <div class="navbar-header slideInOut">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item" v-on:click="miniSidebar = !miniSidebar" > <a class="nav-link hidden-sm-down waves-effect waves-dark" href="javascript:void(0)"><i class="fas fa-bars"></i></a> </li>
                <!-- ============================================================== -->
                <!-- Search -->
                <!-- ============================================================== -->
            ...
            <b-navbar-nav class=" my-lg-0">
                ...
                <!-- Comment -->
                <!-- ============================================================== -->
                <li v-bind:class="['nav-item dropdown', {show: show == 'item_1'}]">
                    <a v-on:click.prevent="showClass('item_1')" v-bind:class="['nav-link dropdown-toggle waves-effect waves-dark']" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="icon-Bell"></i>
                        <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                    </a>
                    <div v-bind:class="['dropdown-menu dropdown-menu-right mailbox', {show: show == 'item_1'}]">
                        <ul>
                            <li>
                ...
                <li class="nav-item dropdown">
                    <a v-on:click.prevent="showClass('item_2')" v-bind:class="['nav-link dropdown-toggle waves-effect waves-dark', {show: show == 'item_2'}]" href="" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="icon-Mail"></i>
                        <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                    </a>
                    <div  v-bind:class="['dropdown-menu dropdown-menu-right mailbox', {show: show == 'item_2'}]"  aria-labelledby="2">
                        <ul>
                            <li>
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="" alt="user" class="" /> <span class="hidden-md-down">Mark Sanders &nbsp;<i class="fa fa-angle-down"></i></span> </a>
